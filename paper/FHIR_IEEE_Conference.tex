...
\caption{Arquitectura distribuida NCS Clinical. Nodos hospitalarios
...
\begin{table}[htbp]
\caption{Stack Tecnol\'ogico del Prototipo NCS Clinical}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{fig_formulario.jpg}}
...
Fuente: prototipo NCS Clinical (may-2026).}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.7\columnwidth]{fig_login.jpg}}
\caption{Pantalla de autenticaci\'on OAuth2/JWT del sistema NCS Clinical.
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{fig_observation.jpg}}
\caption{Respuesta JSON del endpoint \texttt{/fhir/Observation}.
Recurso con c\'odigo LOINC 8480-6 en estado ``final'', con fuente y
versi\'on trazables. Fuente: prototipo NCS Clinical (may-2026).}
\label{fig:obs}
\end{figure}
...
\url{https://github.com/danilocortinez123-netizen/NCS.Clinical-Distribuido}
...
colaboradores del proyecto NCS Clinical por su contribuci\'on al
